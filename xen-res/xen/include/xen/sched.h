...
/*
* Shadow Device Drivers handler 
* This structure enables us to track if VMs DD (Device Driver) work correctly
*/
...
struct domain
{
    ...
    /* Handler for Shadow driver mechanism*/
    struct sd_vm_dd_ft *nic_sd_handler; /* For NICs */
    struct sd_vm_dd_ft *blk_sd_handler; /* For BLKs */
    ...
    bool             is_pinned;
    /* Is this a toolstack domain (not dom0)? */
    bool             is_toolstack;
