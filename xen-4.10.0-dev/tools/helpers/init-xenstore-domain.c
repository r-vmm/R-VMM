...
static int build(xc_interface *xch)
{
    ...
    fprintf(stdout,"Successfully opened /dev/xen/xenbus_backend\n");
    ...
    else
    {
        ...
        fprintf(stdout,"ssid set to SECINITSID_DOMU\n");
    }
    fprintf(stdout,"xc_domain_create called ().....");
    ...
    fprintf(stdout,"xen boot initialisation OK \n");
    ...
    fprintf(stderr,"could build the image successfully\n");
    ...
    fprintf(stdout, "xenstore domain unpaused successfully\n");
...
int main(int argc, char** argv)
{
    ...
    if ( !rv ){
        fprintf(stdout, "Starting build process \n");
        rv = build(xch);
    ...
    if ( rv )
        return 3;
    fprintf(stdout, "Build process finished ....\n");
    xsh = xs_open(0);
    if ( !xsh )
    {
    ...
    fprintf(stdout, "Done writing information in xenstore. View with xenstore-ls \n");
    xs_close(xsh);
    ...
    fprintf(stdout, "Created " XEN_RUN_DIR "/xenstored.pid successfully\n");
    ...
    fprintf(stdout, "Xenstore created successfully. View logs to " XEN_RUN_DIR "/xenstored.pid\n");
